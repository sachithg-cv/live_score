...
export class MatchCreateComponent implements OnInit {
    ...
    ngOnInit(): void {
        ...
        .subscribe((res)=> {
            ...
            this.teams = val;
            this.globals = res[1];
            const { wide, noBall, isIllegalDeliveryDiscarded} = this.globals.matchSetting;
    ...
    createMatch(): void{
        ...
        const {team1, team2, wide, noBall, isIllegalDeliveryDiscarded} = this.matchCreateForm.value;
